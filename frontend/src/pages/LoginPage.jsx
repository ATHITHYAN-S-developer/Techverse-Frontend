    ...
    <div className="min-h-[calc(100vh-80px)] w-full bg-white flex flex-col md:flex-row overflow-hidden">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex items-center justify-between mb-6 md:mb-4">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-500 hover:text-[#0062A8] transition-colors px-3 py-1.5 rounded-full bg-gray-50 hover:bg-blue-50 border border-gray-200/60"
          >
            <ArrowLeft size={14} />
          ...
          >
            {roles.map((role) => {
              ...
              return (
                ...
                >
                  <Icon size={18} className={isActive ? "text-[#0062A8]" : "text-gray-400"} />
        ...
        {/* Bottom Copyright */}
        <div className="text-xs text-gray-400 text-center md:text-left mt-4">
