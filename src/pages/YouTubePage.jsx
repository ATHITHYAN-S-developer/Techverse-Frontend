 ...
 * Path: /youtube
 * Offers both Horizontal Snap Showcase and Category Grid Explorer with real-time search & direct channel links.
 */
...
export default function YouTubePage() {
  ...
  const filteredResources = useMemo(() => {
    return youtubeResources.filter((res) => {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 border border-sky-300 text-xs font-bold uppercase tracking-widest text-[#0062A8] mb-3 shadow-2xs">
                <Tv size={13} className="text-[#0062A8]" />
                <span>SECTION 04 • VIDEO CREATORS & LABS</span>
              </div>
              ...
              <p className="mt-3 text-sm sm:text-base text-slate-600 leading-relaxed font-medium max-w-xl">
                Explore verified YouTube creators delivering concise code tutorials, AI paper dissections, semiconductor physics, and machine learning lectures.
              </p>
            </div>
        ...
        <main className="w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Search channels by creator name, topic, or tag..."
          ...
          {filteredResources.length === 0 ? (
            <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center space-y-4 shadow-xs">
              ...
              <h3 className="text-base font-extrabold text-slate-800">No channels match your search</h3>
              <p className="text-xs sm:text-sm text-slate-500">Try searching for Fireship, Andrew Ng, or AI research.</p>
            </div>
          ) : (
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        <span className="p-2 rounded-2xl bg-red-50 text-red-600 group-hover:scale-110 transition-transform">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                      <span className="text-[11px] font-semibold text-slate-400">
                        {resource.platform || "YouTube Channel"}
                      </span>
